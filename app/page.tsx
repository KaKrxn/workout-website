...
export default async function LandingPage(){
 ...
 <section className="ft-landing-stats">{[["41",en?"Exercises across 4 logging types":"ท่าออกกำลังกาย 4 ชนิดการบันทึก"],["7 → ∞",en?"7-day template auto-generated into months":"เทมเพลต 7 วัน สร้างล่วงหน้าเป็นเดือน"],["2",en?"Taps to log one set":"แตะเพื่อบันทึก 1 เซ็ต"]].map(([v,l])=><div key={v}><strong>{v}</strong><span className="ft-muted">{l}</span></div>)}</section>
